...
online version: docs/functions/New-SNOWSCRequestedItem.md
schema: 2.0.0
---

# New-SNOWSCRequestedItem
...
```
New-SNOWSCRequestedItem [[-backordered] <Boolean>] [[-billable] <Boolean>] [[-cat_item] <String>]
 ...
 [[-additional_assignee_list] <String>] [[-approval] <String>] [[-approval_set] <String>]
 [[-assigned_to] <String>] [[-assignment_group] <String>] [[-business_service] <String>] [[-cmdb_ci] <String>]
 [[-comments] <String>] [[-comments_and_work_notes] <String>] [[-company] <String>] [[-delivery_plan] <String>]
...
[https://github.com/insomniacc/PSServiceNow/blob/main/docs/functions/New-SNOWSCRequestedItem.md](https://github.com/insomniacc/PSServiceNow/blob/main/docs/functions/New-SNOWSCRequestedItem.md)
