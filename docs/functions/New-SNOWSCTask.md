...
```
New-SNOWSCTask [[-request_item] <String>] [[-active] <Boolean>] [[-activity_due] <String>]
 ...
 [[-comments] <String>] [[-comments_and_work_notes] <String>] [[-delivery_plan] <String>]
 ...
 [[-state] <String>] [[-urgency] <String>] [[-user_input] <String>] [[-watch_list] <String>]
...
[https://github.com/insomniacc/PSServiceNow/blob/main/docs/functions/New-SNOWSCTask.md](https://github.com/insomniacc/PSServiceNow/blob/main/docs/functions/New-SNOWSCTask.md)
