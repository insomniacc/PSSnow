...
Module Name: PSSnow
online version: docs/functions/Set-SNOWApprovalGroup.md
schema: 2.0.0
---

# Set-SNOWApprovalGroup
...
```
Set-SNOWApprovalGroup [[-admin_override] <Boolean>] [[-approval_user] <String>] [[-reject_handling] <String>]
 [[-wait_for] <String>] [[-active] <Boolean>] [[-activity_due] <String>] [[-additional_assignee_list] <String>]
 [[-approval] <String>] [[-approval_set] <String>] [[-assigned_to] <String>] [[-assignment_group] <String>]
 ...
 [[-work_start] <String>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] -Sys_ID <String>
...
[https://github.com/insomniacc/PSSnow/blob/main/docs/functions/Set-SNOWApprovalGroup.md](https://github.com/insomniacc/PSSnow/blob/main/docs/functions/Set-SNOWApprovalGroup.md)
