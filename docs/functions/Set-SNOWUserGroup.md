...
Module Name: PSSnow
online version: docs/functions/Set-SNOWUserGroup.md
schema: 2.0.0
---
...
```
Set-SNOWUserGroup [[-active] <Boolean>] [[-cost_center] <String>] [[-default_assignee] <String>]
 ...
 [[-type] <String>] [-WhatIf] [-Confirm] -Sys_ID <String> [-Properties <Hashtable>] [-InputDisplayValue]
...
[https://github.com/insomniacc/PSSnow/blob/main/docs/functions/Set-SNOWUserGroup.md](https://github.com/insomniacc/PSSnow/blob/main/docs/functions/Set-SNOWUserGroup.md)
